...
class BertHAM():
    ...
    def predict_one_automatic_turn(self, partial_example, unique_id, example_idx, tokenizer):
        ...
        self.QA_history.append((len(self.QA_history), question, (pred_text, pred_answer_s, pred_answer_e)))
        # self.QA_history.append((turn, question, (pred_text, pred_answer_s, pred_answer_e)))
        turn = int(partial_example.qas_id.split("#")[1])
        print(f'------------turn-------{turn}------')
        print(turn)
        self.QA_history_ham.append((turn, question, (pred_text, pred_answer_s, pred_answer_e)))
