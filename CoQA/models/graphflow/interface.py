...
from models.graphflow.model import QuACModel,CoQAModel
...
class GraphFlow():
    def __init__(self, args):
        ...
        self.model = CoQAModel(self.args)
        self.QA_history = []
        self.history = []
    ...
    def predict_one_automatic_turn(self, partial_example, unique_id, example_idx, tokenizer):
        ...
        qa = {
            ...
            'answer_type_targets':partial_example['answer_type_targets'],
        }
        temp = []
        marker = []
        ...
        for step, input_batch in enumerate(test_loader):
            ...
            ### 修复标记问题
            self.QA_history.append((qa['turn_id'], " ".join(original_question), (" ".join(tokens), span[0], span[1])))
            print(self.QA_history)
